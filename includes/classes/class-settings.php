...
if ( ! class_exists( 'TINYPRESS_Settings' ) ) {
	class TINYPRESS_Settings {
		...
		function render_field_tinypress_browsers( $args ) {

			echo '<p class="tinypress-extensions-message">' . esc_html__( 'We have developed extensions for the below browsers.', 'tinypress' ) . '</p>';
			...
			echo '<p class="tinypress-extensions-message">' . esc_html__( 'Here is a video that can help you to understand how the extension will work.', 'tinypress' ) . '</p>';
		...
		function get_settings_pages() {
			...
			$field_sections['support'] = array(
				'title'    => esc_html__( 'Supports', 'tinypress' ),
				'sections' => array(
					array(
